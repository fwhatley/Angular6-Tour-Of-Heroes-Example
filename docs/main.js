    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                // remove it whne a real server is ready fto receive requests
...
var HeroDetailComponent = /** @class */ (function () {
    ...
    HeroDetailComponent.prototype.getHero = function () {
        var _this = this;
        var id = +this.route.snapshot.paramMap.get('id'); // <-- + casts string into number
...
var HeroSearchComponent = /** @class */ (function () {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        // wait 300ms after each keystroke before considerign the term
...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.getHero = function (id) {
        ...
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("fetched hero id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getHero id=" + id)));
    };
    /** PUT: update the hero on teh server */
    ...
    HeroService.prototype.addHero = function (hero) {
        ...
        return this.http.post(this.heroesUrl, hero, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (hero) { return _this.log("added hero w/ id=" + hero.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addHero')));
    };
    ...
    /** GET heroe whose name contains the term */
    ...
    HeroService.prototype.handleError = function (operation, result) {
        ...
        return function (error) {
            ...
            // TODO: better job of trasnforming error for use consumption
            _this.log(operation + " failed: " + error.message);
            // let the app keep running by returning an empy result.
...
var MessagesComponent = /** @class */ (function () {
    function MessagesComponent(messageService) {
        this.messageService = messageService;
    } // <-- public bc svc will used in the template
...
module.exports = __webpack_require__(/*! C:\Users\fwhatley\Desktop\angular-tour-of-heroes\src\main.ts */"./src/main.ts");
